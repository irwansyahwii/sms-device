...
class SmsDevice {
    ...
    static create() {
        ...
        }, new WavecomModemDriver_1.WavecomModemDriver(), new GammuIdentifyMetadataParser_1.GammuIdentifyMetadataParser(), new GammuSmsMetadataParser_1.GammuSmsMetadataParser());
    }
